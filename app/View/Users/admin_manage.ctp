							...
							<div class="main-content">
								...
								<table class="manager-table"  style="text-align: left;">
									<thead class="text-color1">
										...
										<th class="sort-enable <?php echo ($data['sort']['sort'] == 'firstname') ? 'active' : '' ?>">
											<?php if(($data['sort']['sort'] == 'firstname') && ($data['sort']['direction'] == 'desc')): ?>
												<i class="icon icon-arrow-down"></i>
											<?php endif; ?>
											<?php if(($data['sort']['sort'] == 'firstname') && ($data['sort']['direction'] == 'asc')): ?>
												<i class="icon icon-arrow-up"></i>
											<?php endif; ?>
											<?php echo $this->Paginator->sort('firstname', __('Firstname')) ?>
										</th>
										<th class="sort-enable <?php echo ($data['sort']['sort'] == 'lastname') ? 'active' : '' ?>">
											<?php if(($data['sort']['sort'] == 'lastname') && ($data['sort']['direction'] == 'desc')): ?>
												<i class="icon icon-arrow-down"></i>
											<?php endif; ?>
											<?php if(($data['sort']['sort'] == 'lastname') && ($data['sort']['direction'] == 'asc')): ?>
												<i class="icon icon-arrow-up"></i>
											<?php endif; ?>
											<?php echo $this->Paginator->sort('lastname', __('Lastname')) ?>
										</th>
				...
				<div class="side-input-content">
					<table>
						...
						<tr>
							...
							<td><?php echo $this->Form->input('firstname', array(
								'value' => isset($data['edit']['User']['firstname']) ? $data['edit']['User']['firstname'] : '',
							)) ?></td>
						</tr>
						<tr>
							<td><?php echo __('Last Name') ?></td>
							<td><?php echo $this->Form->input('lastname', array(
								'value' => isset($data['edit']['User']['lastname']) ? $data['edit']['User']['lastname'] : '',
							)) ?></td>
						</tr>
